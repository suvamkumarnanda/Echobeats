...
import stereo from "../assets/echobeats.png";
...
const AudioPlayer = () => {
  ...
  return (
    <div
    className="fixed flex justify-between items-center bottom-0 right-0 left-0 bg-teal-900 text-white px-3 lg:px-5 py-2 shadow-xl"
  >
