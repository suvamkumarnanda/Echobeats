...
import back from "../assets/echobeats.png";
...
const Navbar = () => {
  ...
  return (
    <header className="z-50 w-full sticky bg-teal-900 text-black top-0 flex flex-col justify-between items-center py-1 lg:py-2 px-10 font-space shadow-2xl h-14 lg:h-16 ">
      <nav className=" mx-auto w-full flex justify-between items-center sticky top-5">
        ...
        <button
          onClick={toggleMenu}
          className="lg:hidden p-2 rounded-md text-gray-300 hover:text-black hover:bg-gray-700 transition-colors duration-200"
      ...
      {/* ------------Mobile Nav------------ */}
      <div
        className={`lg:hidden text-2xl text-black flex flex-col bg-gray-900 w-64 fixed z-50 top-0 p-6 h-screen items-start justify-start space-y-8 pt-20 transition-transform duration-300 ease-in-out ${sideBar.showMenu ? "right-0 transform-none" : "-right-64 transform"
          }`}
      >
